...
namespace Assistenza.BufDalsi.Data.Models
{
    public class Vasca
    {
        ...
        public Vasca(string Nome, int Id, double Altezza, Boolean Coperta, Boolean Riscaldata, Boolean Recupero, Boolean Interrata, double Interramento, int nSoffiantine, double Diametro, int Impianto)
        {
            vsc_Nome = Nome;
            vsc_Id = Id;
            vsc_Altezza = Altezza;
