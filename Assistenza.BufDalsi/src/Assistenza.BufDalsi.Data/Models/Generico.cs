...
namespace Assistenza.BufDalsi.Data.Models
{
    ...
    {
        public Generico(int gnr_Id, string gnr_Nome, DateTime gnr_UltimaInstallazione, DateTime gnr_UltimoIntervento, float gnr_OreUltimoIntervento, string gnr_Marca, string gnr_Modello, string gnr_Serie, bool gnr_Rimosso, string gnr_Descrizione, int gnr_Impianto)
        {
            this.gnr_Id = gnr_Id;
