...
{
    public class InsertAgitatoreViewModel
    {
        ...
        public InsertAgitatoreViewModel()
        {
            agt_UltimaInstallazione = new DateTime(1900, 01, 01);
            agt_UltimoIntervento = new DateTime(1900, 01, 01);
        }
        public InsertAgitatoreViewModel(int id, string nome, DateTime ultinst, DateTime ultint, int oreuint, string mar, string mod, string sernum, Boolean rimo, int vsc)
        {
            agt_Id = id;
            agt_Nome = nome;
